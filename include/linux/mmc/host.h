...
#define MMC_CAP2_CRYPTO		(1 << 27)	/* Host supports inline encryption */
	...
	bool              bad_card;     /* indicates a bad card */
	unsigned int        int_cnt_enable; /* indicates enable record the int_cnt */
	unsigned int        int_cnt;    /* for statistics interrupts count */
	bool              fast_power_off;  /* power off quickly */
	bool              vmc_vol_1800;  /*   vmc 1.86v -> 1.8v */
	bool				speed_mode_sdr104;	/*    speed_mode sdr104 */

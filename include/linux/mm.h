...
//vivo pengmingming modify for page poison begin
#ifdef CONFIG_PAGE_POISONING
extern bool page_poisoning_enabled(void);
extern unsigned int bsp_test_mode;
extern void __kernel_poison_pages(struct page *page, int numpages, int enable);
extern bool page_is_poisoned(struct page *page);
static inline void
kernel_poison_pages(struct page *page, int numpages, int enable)
{
	if (likely(!bsp_test_mode))
		return;
	__kernel_poison_pages(page, numpages, enable);
}
//vivo pengmingming modify for page poison end
#else

...
#include "../scp_spk/mtk-scp-spk-common.h"
 ...
 struct mtk_base_afe *afe_base; //baoqiang add for i2s setting
...
******************************************************************************/
static void __init mt6833_proc_dump_register(struct mtk_base_afe *afe)
{
	...
	entry = proc_create_data("mtksocaudio", 0664, NULL, &mt6833_debugfs_ops, afe);
	if (!entry)
...
static int mt6833_afe_pcm_dev_probe(struct platform_device *pdev)
{
	...
	afe_base = afe; //baoqiang add for i2s seting

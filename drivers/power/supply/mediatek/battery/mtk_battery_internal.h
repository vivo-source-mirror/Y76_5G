...
do {\
	if (BMLOG_INFO_LEVEL >= BMLOG_ERROR_LEVEL) {\
		pr_notice(fmt, ##args); \
	} \
} while (0)
...
do {\
	if (BMLOG_INFO_LEVEL >= BMLOG_WARNING_LEVEL) {\
		pr_notice(fmt, ##args); \
	}								   \
} while (0)
...
do {\
	if (BMLOG_INFO_LEVEL >= BMLOG_NOTICE_LEVEL) {\
		pr_notice(fmt, ##args); \
	}								   \
} while (0)
...
do {\
	if (BMLOG_INFO_LEVEL >= BMLOG_INFO_LEVEL) {\
		pr_notice(fmt, ##args); \
	}								   \
} while (0)
...
do {\
	if (BMLOG_INFO_LEVEL >= BMLOG_DEBUG_LEVEL) {\
		pr_notice(fmt, ##args); \
	}								   \
} while (0)
...
do {\
	if (BMLOG_INFO_LEVEL >= BMLOG_TRACE_LEVEL) {\
		pr_notice(fmt, ##args);\
	}						\
} while (0)

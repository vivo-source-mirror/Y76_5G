...
/*add by daizhihui for vivo_pem frozen begin*/
#ifdef CONFIG_VIVO_BINDER_SPACE
#define BINDER_FREE_SPACE_THD    200000  // 1/10 of total space
#define SYSTEM_UID               10000
extern void notify_pem_binder_state(int uid, int pid, char *s);
#endif
/*add by daizhihui for vivo_pem frozen end*/
...
//vivo jingruiguang add for vivo_pem frozen end
	...
	/*add by jingruiguang for vivo_pem frozen begin*/
#ifdef CONFIG_VIVO_BINDER_SPACE	
	...
	/*add by jingruiguang for vivo_pem frozen end*/
#endif

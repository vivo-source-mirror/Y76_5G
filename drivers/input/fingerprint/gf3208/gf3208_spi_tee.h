...
#define GF_IOC_SEND_MODE   _IOW(GF_IOC_MAGIC, 15, int)
#define GF_IOC_WAKE_LOCK   _IOW(GF_IOC_MAGIC, 16, int)

#define GF_IOC_WAKE_UP          _IOW(GF_IOC_MAGIC, 17, uint8_t)
...
static int gf_ioctl_transfer_raw_cmd(struct gf_device *gf_dev, unsigned long arg,unsigned int bufsiz);
static int gf_ioctl_spi_init_cfg_cmd(struct mt_chip_conf *mcc, unsigned long arg);
*/

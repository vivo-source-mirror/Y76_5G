...
static irqreturn_t gf_irq(int irq, void *handle)
{
	...
	gf_netlink_send(gf_dev, GF_NETLINK_IRQ);
	gf_dev->sig_count++;
	pr_info("gf,%s,need_wake_flag:%d,ff_mode_state:%d.\n", __func__, need_wake_flag, ff_mode_state);
...
static int __init gf_init(void)
{
	...
	if (get_fp_id() != GOODIX_GF3208 && get_fp_id() != GOODIX_GF5288 && get_fp_id() != GOODIX_GF3658 && get_fp_id() != GOODIX_GF3626 && get_fp_id() != GOODIX_GF3636) {

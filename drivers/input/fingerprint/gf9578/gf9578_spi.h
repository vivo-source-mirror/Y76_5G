...
/* fp pm qos opp mode, need same as kernel defined */
#define GF_IOC_PM_QOS_REQUEST   _IO(GF_IOC_MAGIC, 21)
#define GF_IOC_PM_QOS_RELEASE   _IO(GF_IOC_MAGIC, 22)
...
#define SPI_LOW_SPEED       (1000000 * 4 * 1) //1M
...
struct gf_dev {
	...
	signed int vdd_en_gpio;
	signed int vddio_en_gpio;

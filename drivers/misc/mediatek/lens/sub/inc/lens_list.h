...
#define GT9772HAF_SetI2Cclient GT9772HAF_SetI2Cclient_Sub
#define GT9772HAF_Ioctl GT9772HAF_Ioctl_Sub
#define GT9772HAF_Release GT9772HAF_Release_Sub
#define GT9772HAF_PowerDown GT9772HAF_PowerDown_Sub
#define GT9772HAF_GetFileName GT9772HAF_GetFileName_Sub
extern int GT9772HAF_SetI2Cclient(struct i2c_client *pstAF_I2Cclient,
				 spinlock_t *pAF_SpinLock, int *pAF_Opened);
extern long GT9772HAF_Ioctl(struct file *a_pstFile, unsigned int a_u4Command,
			   unsigned long a_u4Param);
extern int GT9772HAF_Release(struct inode *a_pstInode, struct file *a_pstFile);
extern int GT9772HAF_PowerDown(struct i2c_client *pstAF_I2Cclient,
				int *pAF_Opened);
extern int GT9772HAF_GetFileName(unsigned char *pFileName);

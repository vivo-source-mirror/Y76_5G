...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = OV64B40PD2102_SENSOR_ID,
...
kal_uint16  crosstalk_main_ov64b40_reg[288*2];
...
static kal_uint16 addr_data_pair_custom1[] = { // 4000x3000
0x0305,0x00,
0x0325,0x40,
0x0326,0xc3,
0x0327,0x03,
...
static void sensor_init(void)
{
   ...
   // kdSetI2CSpeed(imgsensor_info.i2c_speed);
	...
	table_write_cmos_sensor(crosstalk_main_ov64b40_reg,
		   sizeof(crosstalk_main_ov64b40_reg) / sizeof(kal_uint16));
...
static kal_uint32 return_sensor_id(void)
{
    ...
    return (((read_cmos_sensor_16_8(0x300b) << 8) | ((read_cmos_sensor_16_8(0x300c)))) + 2);
}
			  ...
			  MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
	...
	pr_err("ov64bpd2102 call scenario_id = %d\n", scenario_id);
				  ...
				  UINT8 *feature_para, UINT32 *feature_para_len)
{
	...
	case SENSOR_FEATURE_GET_OFFSET_TO_START_OF_EXPOSURE: 	/*ITS test_sensor_fusion */
		*(MUINT32 *)(uintptr_t)(*(feature_data + 1)) = 5957000;
  		break;
#elif defined(CONFIG_MTK_CAM_PD2102)
	case SENSOR_FEATURE_GET_OFFSET_TO_START_OF_EXPOSURE: 	/*ITS test_sensor_fusion */
		*(MUINT32 *)(uintptr_t)(*(feature_data + 1)) = 2400000;
		break;
#endif
...
UINT32 OV64B40PD2102_MIPI_RAW_SensorInit(

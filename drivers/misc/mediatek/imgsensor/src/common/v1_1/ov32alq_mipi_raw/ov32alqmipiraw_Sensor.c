...
MUINT32  crosstalk_main_ov32alq_flag;
MUINT32  material_inf_main_ov32alq[4];
kal_uint16  add_data_pair_crosstalk[VIVO_CROSSTALK_DATASIZE*2];
...
{
	//Global setting
	if(0x01 == crosstalk_main_ov32alq_flag){
		table_write_cmos_sensor(add_data_pair_crosstalk,
				sizeof(add_data_pair_crosstalk) / sizeof(kal_uint16));
	}
    PK_DBG("start");
			  ...
			  MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
	...
	pr_err("info:ov32a scenario_id = %d\n", scenario_id);
	spin_unlock(&imgsensor_drv_lock);
	switch (scenario_id) {
	case MSDK_SCENARIO_ID_CAMERA_PREVIEW:
	...
	enum MSDK_SCENARIO_ID_ENUM scenario_id,	MUINT32 framerate)
{
	...
	pr_err("info:ov32a scenario_id = %d, framerate = %d\n", scenario_id, framerate);
				  ...
				  UINT8 *feature_para, UINT32 *feature_para_len)
{
	...
	case SENSOR_FEATURE_GET_OFFSET_TO_START_OF_EXPOSURE: 	/*ITS test_sensor_fusion */
  		*(MUINT32 *)(uintptr_t)(*(feature_data + 1)) = 4455000;
  		break;

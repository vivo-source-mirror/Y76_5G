...
#include "gc02m1bpd2156fmipimono_Sensor.h"

/****************************Modify Following Strings for Debug****************************/
#define PFX "GC02M1BPD2156F_camera_sensor"
#define LOG_1 LOG_INF("GC02M1BPD2156F,MIPI 1LANE\n")
/****************************   Modify end    *******************************************/
...
static struct imgsensor_info_struct imgsensor_info = {
	/*.sensor_id = GC02M1BPD2156F_SENSOR_ID, */
	.sensor_id = GC02M1BPD2156F_SENSOR_ID,
...
static void set_shutter_frame_length(kal_uint16 shutter, kal_uint16 frame_length)
{
	...
	imgsensor.shutter = shutter;
	spin_unlock_irqrestore(&imgsensor_drv_lock, flags);
	LOG_INF("aad_auto_extend_en Enter set shutter frame length! shutter =%d\n", shutter);
...
static kal_uint16 set_gain(kal_uint16 gain)
{
	...
	if ((ANALOG_GAIN_1 <= iReg) && (iReg < ANALOG_GAIN_2)) {
		...
		LOG_INF
		    ("GC02M1BPD2156FMIPI analogic gain 1x, GC02M1BPD2156FMIPI add pregain = %d\n",
		     temp);
		...
		write_cmos_sensor(0xb2, (temp & 0xff));
		LOG_INF
		    ("GC02M1BPD2156FMIPI analogic gain 1.185x, GC02M1BPD2156FMIPI add pregain = %d\n",
		     temp);
		...
		write_cmos_sensor(0xb2, (temp & 0xff));
		LOG_INF
		    ("GC02M1BPD2156FMIPI analogic gain 1.4x, GC02M1BPD2156FMIPI add pregain = %d\n",
		     temp);
		...
		write_cmos_sensor(0xb2, (temp & 0xff));
		LOG_INF
		    ("GC02M1BPD2156FMIPI analogic gain 1.659x, GC02M1BPD2156FMIPI add pregain = %d\n",
		     temp);
		...
		write_cmos_sensor(0xb2, (temp & 0xff));
		LOG_INF
		    ("GC02M1BPD2156FMIPI analogic gain 2.0x, GC02M1BPD2156FMIPI add pregain = %d\n",
		     temp);
		...
		write_cmos_sensor(0xb2, (temp & 0xff));
		LOG_INF
		    ("GC02M1BPD2156FMIPI analogic gain 2.37x, GC02M1BPD2156FMIPI add pregain = %d\n",
		     temp);
		...
		write_cmos_sensor(0xb2, (temp & 0xff));
		LOG_INF
		    ("GC02M1BPD2156FMIPI analogic gain 2.8x, GC02M1BPD2156FMIPI add pregain = %d\n",
		     temp);
		...
		write_cmos_sensor(0xb2, (temp & 0xff));
		LOG_INF
		    ("GC02M1BPD2156FMIPI analogic gain 3.318x, GC02M1BPD2156FMIPI add pregain = %d\n",
		     temp);
		...
		write_cmos_sensor(0xb2, (temp & 0xff));
		LOG_INF
		    ("GC02M1BPD2156FMIPI analogic gain 4.0x, GC02M1BPD2156FMIPI add pregain = %d\n",
		     temp);
		...
		write_cmos_sensor(0xb2, (temp & 0xff));
		LOG_INF
		    ("GC02M1BPD2156FMIPI analogic gain 4.74x, GC02M1BPD2156FMIPI add pregain = %d\n",
		     temp);
		...
		write_cmos_sensor(0xb2, (temp & 0xff));
		LOG_INF
		    ("GC02M1BPD2156FMIPI analogic gain 5.6x, GC02M1BPD2156FMIPI add pregain = %d\n",
		     temp);
		...
		write_cmos_sensor(0xb2, (temp & 0xff));
		LOG_INF
		    ("GC02M1BPD2156FMIPI analogic gain 6.636x, GC02M1BPD2156FMIPI add pregain = %d\n",
		     temp);
		...
		write_cmos_sensor(0xb2, (temp & 0xff));
		LOG_INF
		    ("GC02M1BPD2156FMIPI analogic gain 8.0x, GC02M1BPD2156FMIPI add pregain = %d\n",
		     temp);
		...
		write_cmos_sensor(0xb2, (temp & 0xff));
		LOG_INF
		    ("GC02M1BPD2156FMIPI analogic gain 9.48x, GC02M1BPD2156FMIPI add pregain = %d\n",
		     temp);
		...
		write_cmos_sensor(0xb2, (temp & 0xff));
		LOG_INF
		    ("GC02M1BPD2156FMIPI analogic gain 11.2x, GC02M1BPD2156FMIPI add pregain = %d\n",
		     temp);
	}
	else {
		write_cmos_sensor(0xfe, 0x00);
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
	...
	kal_uint8 timeout = 0;
	timeout = check_i2c_timeout(0x02e1, imgsensor.i2c_write_id);
    if (timeout) {
				  ...
				  UINT32 *feature_para_len)
{
	...
	case SENSOR_FEATURE_GET_FRAME_CTRL_INFO_BY_SCENARIO:
		...
		switch (*feature_data) {
			case MSDK_SCENARIO_ID_CAMERA_CAPTURE_JPEG:
				*(feature_data + 1) = 1;
		    	*(feature_data + 2) = imgsensor_info.margin;   ////imgsensor_info.margin
				break;
			case MSDK_SCENARIO_ID_VIDEO_PREVIEW:
				*(feature_data + 1) = 1;
		    	*(feature_data + 2) = imgsensor_info.margin;   ////imgsensor_info.margin
...
UINT32 GC02M1BPD2156F_MIPI_MONO_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
	/* To Do : Check Sensor status here */
	if (pfFunc != NULL)
		*pfFunc = &sensor_func;
	return ERROR_NONE;
}				/*    GC02M1BPD2156F_MIPI_RAW_SensorInit    */

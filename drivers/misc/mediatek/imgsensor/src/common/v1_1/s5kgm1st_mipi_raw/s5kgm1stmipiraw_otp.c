...
int MAIN_F8D1_otp_read(void)
{
	...
	if ((0x01 == vivo_otp_data_s5kgm1st[ModuleInfo_addr]) && 
		...
		((0x01 == vivo_otp_data_s5kgm1st[PDAF_proc2_addr]) || (0x01 == vivo_otp_data_s5kgm1st[PDAF_proc2_v3_8_addr])) &&
		(0x01 == vivo_otp_data_s5kgm1st[Coefficient_of_light_source_addr])) {
	...
	if (check_if_group_valid == 0x01) { /****all the data is valid****/
		/****ModuleInfo****/
		if ((VIVO_VENDOR_OFILM != vivo_otp_data_s5kgm1st[0x01]) ) {

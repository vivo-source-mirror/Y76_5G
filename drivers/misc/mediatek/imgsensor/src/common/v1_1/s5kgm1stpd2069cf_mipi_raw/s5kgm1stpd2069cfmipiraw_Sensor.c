 ...
 * Filename:
 * ---------
 *	 s5kgm1stpd2069cfmipiraw_Sensor.c
 *
 * Project:
 * --------
 *	 ALPS
...
#include "s5kgm1stpd2069cfmipiraw_freq.h"
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = S5KGM1STPD2069CF_SENSOR_ID,
	...
	.normal_video = {
		...
		.mipi_data_lp2hs_settle_dc = 85,
		.mipi_pixel_rate = 482400000,/*511200000*/
		.max_framerate = 300,
	},
	.hs_video = { /*hs_video 120fps*/
		...
		.mipi_data_lp2hs_settle_dc = 85,
		.mipi_pixel_rate = 482900000, //1848
		.max_framerate = 1200,
		},
	.slim_video = { /* hs_video 240fps*/
		...
		.mipi_data_lp2hs_settle_dc = 85,
		.mipi_pixel_rate = 483500000, //1848
		.max_framerate = 2400,
		},
...
static struct SET_PD_BLOCK_INFO_T imgsensor_pd_info = 
{
    ...
    .i4BlockNumY = 90,
    .i4LeFirst = 0,
	.i4Crop = { {0, 0}, {0, 0}, {0, 372}, {0, 0}, {0, 0}, {368, 276}, {0, 0}, {0, 0}, {0, 0}, {0, 0} },
	.iMirrorFlip = 0,
};
...
{  // Preview mode setting        tail size 496X720
   {0x02, 0x0A,   0x00,   0x08, 0x40, 0x00,
    0x00, 0x2B, 0x1220, 0x0DA0, 0x01, 0x00, 0x0000, 0x0000,
    0x01, 0x30, 0x026C, 0x02D0, 0x03, 0x00, 0x0000, 0x0000},
   // Capture mode setting       tail size 496X720
   {0x02, 0x0A,   0x00,   0x08, 0x40, 0x00,
    0x00, 0x2B, 0x1220, 0x0DA0, 0x01, 0x00, 0x0000, 0x0000,
    0x01, 0x30, 0x026C, 0x02D0, 0x03, 0x00, 0x0000, 0x0000},
   // Video mode setting         tail size 496X560
   {0x02, 0x0A,   0x00,   0x08, 0x40, 0x00,
    0x00, 0x2B, 0x1220, 0x0DA0, 0x01, 0x00, 0x0000, 0x0000,
    0x01, 0x30, 0x026C, 0x0230, 0x03, 0x00, 0x0000, 0x0000},
   // Video mode 60fps setting   tail size 496X560
   {0x02, 0x0A,   0x00,   0x08, 0x40, 0x00,
    0x00, 0x2B, 0x1220, 0x0DA0, 0x01, 0x00, 0x0000, 0x0000,
    0x01, 0x30, 0x026C, 0x0230, 0x03, 0x00, 0x0000, 0x0000},
   // Custom1 mode 3264x2448 24fps setting  tail size 408X608
   {0x02, 0x0A,   0x00,   0x08, 0x40, 0x00,
    0x00, 0x2B, 0x1220, 0x0DA0, 0x01, 0x00, 0x0000, 0x0000,
    0x01, 0x30, 0x01FE, 0x0260, 0x03, 0x00, 0x0000, 0x0000},
};

/*hope add otp check start*/
static int vivo_otp_read_when_power_on;
extern int MAIN_F8D1_otp_read(void);
extern otp_error_code_t S5KGM1STPD2069CF_OTP_ERROR_CODE;
MUINT32  sn_inf_main_s5kgm1stpd2069cf[13];  /*0 flag   1-12 data*/
MUINT32  material_inf_main_s5kgm1stpd2069cf[4];  
...
0x030E, 0x0003,
0x0312, 0x0001,
0x0310, 0x008B, ////008A   1204.67mbps
0x6028, 0x2000,
0x602A, 0x1492,
0x6F12, 0x007A,
0x602A, 0x0E4E,
	...
	case SENSOR_FEATURE_GET_CUSTOM_INFO:
		...
		switch (*feature_data) {
			...
			if (*feature_para_len >= sizeof(MUINT32)*13 + 2) {
			    *(MUINT32 *)(uintptr_t)(*(feature_data+1)) = S5KGM1STPD2069CF_OTP_ERROR_CODE;//otp_state
				memcpy( feature_data+2, sn_inf_main_s5kgm1stpd2069cf, sizeof(MUINT32)*13); 
				memcpy( feature_data+10, material_inf_main_s5kgm1stpd2069cf, sizeof(MUINT32)*4); 
				#if 0
						for (i = 0 ; i<12 ; i++ ){
						printk("sn_inf_main_s5kgm1stpd2069cf[%d]= 0x%x\n", i, sn_inf_main_s5kgm1stpd2069cf[i]);
						}
				#endif
			}
				break;
...
UINT32 S5KGM1STPD2069CF_MIPI_RAW_SensorInit(

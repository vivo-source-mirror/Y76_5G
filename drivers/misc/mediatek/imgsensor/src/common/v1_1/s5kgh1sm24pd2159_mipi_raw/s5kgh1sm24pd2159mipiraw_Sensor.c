 ...
 * Filename:
 * ---------
 *	 s5kgh1sm24pd2159mipiraw_Sensor.c
 *
 * Project:
 * --------
 *	 ALPS
...
#include "s5kgh1sm24pd2159mipiraw_freq.h"
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = S5KGH1SM24PD2159_SENSOR_ID,
	...
	.normal_video = {	/*16:9 3840*2160 @ 30fps*/
		.pclk =1543000000,
		.linelength = 11360,
		.framelength = 4528,
		.startx =0,
	...
	.custom2 = { /* 4:3 3648*2736@15fps */
	 ...
	 .custom3 = {/* 16:11 7968*5480 @ 15fps (44M fullsize) */
		.pclk =1040000000,
		.linelength = 10252,
		.framelength = 6762,
		.startx =0,
...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[15] = {  
	...
	{ 7968, 5480,	144,	580,	7680, 4320, 3840, 2160,	0000, 0000,	3840,  2160,	  0,	0, 	3840,  2160}, /*video 16:9 3840*2160*/
	{ 7968, 5480,	144,	580,	7680, 4320, 1920, 1080,	0000, 0000,	1920,  1080,	  0,	0, 	1920,  1080}, /*hight speed video 120fps*/
	{ 7968, 5480,	144,	580,	7680, 4320, 1280, 720,	0000, 0000,	1280,  720,	  0,	0, 	1280,  720}, /*slim video  hs_video 120fps*/
...
/*no mirror flip*/
static struct SET_PD_BLOCK_INFO_T imgsensor_pd_info = //3984X2740
{
    .i4OffsetX = 8,
    .i4OffsetY = 10,
    .i4PitchX = 16,
    ...
    .i4BlockNumY = 170,
    .i4LeFirst = 0,
	.i4Crop = {{168, 2}, {0, 0}, {72, 290},{0, 0},{0, 0},{72, 290},{0, 0},{0, 0},{0, 0}, {168, 2},},
	.iMirrorFlip = 0,
};
...
extern otp_error_code_t S5KGH1SM24PD2159_OTP_ERROR_CODE;
MUINT32  sn_inf_sub_s5kgh1sm24pd2159[13];  /*0 flag   1-12 data*/
MUINT32  material_inf_sub_s5kgh1sm24pd2159[4]; 
MUINT32  af_calib_inf_sub_s5kgh1sm24pd2159[6];     
	...
	case SENSOR_FEATURE_GET_CUSTOM_INFO:
		...
		switch (*feature_data) {
			...
			if (*feature_para_len >= sizeof(MUINT32)*13 + 2) {
			    *(MUINT32 *)(uintptr_t)((feature_data+1)) = S5KGH1SM24PD2159_OTP_ERROR_CODE;//otp_state
				memcpy( feature_data+2, sn_inf_sub_s5kgh1sm24pd2159, sizeof(MUINT32)*13); 
				memcpy( feature_data+10, material_inf_sub_s5kgh1sm24pd2159, sizeof(MUINT32)*4); 
				memcpy( feature_data+12, af_calib_inf_sub_s5kgh1sm24pd2159, sizeof(MUINT32)*6);
				#if 0
						for (i = 0 ; i<12 ; i++ ){
						printk("sn_inf_sub_s5kgh1sm24pd2159[%d]= 0x%x\n", i, sn_inf_sub_s5kgh1sm24pd2159[i]);
						}
				#endif
			}
				break;
...
UINT32 S5KGH1SM24PD2159_MIPI_RAW_SensorInit(

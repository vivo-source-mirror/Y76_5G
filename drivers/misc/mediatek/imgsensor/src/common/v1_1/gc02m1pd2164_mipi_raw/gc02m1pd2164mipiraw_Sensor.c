...
#define PFX "GC02M1PD2164_camera_sensor"
#define LOG_1 LOG_INF("GC02M1PD2164,MIPI 1LANE\n")
/****************************   Modify end    *******************************************/
...
extern otp_error_code_t GC02M1PD2164_OTP_ERROR_CODE;
#endif
MUINT32  sn_inf_main2_gc02m1pd2164[13];  /*0 flag   1-12 data*/
MUINT32  material_inf_main2_gc02m1pd2164[4];
...
static struct imgsensor_info_struct imgsensor_info = {
	...
	.sensor_id = GC02M1PD2164_SENSOR_ID,
	...
	.cap1 = {		//capture for PIP 24fps relative information, capture1 mode must use same framelength, linelength with Capture mode for shutter calculate
		 .pclk = 84500000,	//record different mode's pclk
		 .linelength = 2192,	//record different mode's linelength
		 .framelength = 1602,	//record different mode's framelength
		 .startx = 0,	//record different mode's startx of grabwindow
		 .starty = 0,	//record different mode's starty of grabwindow
		 .grabwindow_width = 1600,	//record different mode's width of grabwindow //1296
		 .grabwindow_height = 1200,	//record different mode's height of grabwindow //972
	...
	.custom1 = {
		...
		.starty = 0,	//record different mode's starty of grabwindow
		.grabwindow_width = 1600,	//record different mode's width of grabwindow //1296
		.grabwindow_height = 900,	//record different mode's height of grabwindow //972
		/*     following for MIPIDataLowPwr2HighSpeedSettleDelayCount by different scenario    */
		.mipi_data_lp2hs_settle_dc = 85,	//unit , ns
		/*     following for GetDefaultFramerateByScenario()    */
		.mipi_pixel_rate = 67200000,
...
static struct imgsensor_struct imgsensor = {
	.mirror = MIRROR,	//mirrorflip information
...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[6] = {
	...
	{1600, 1200, 0, 0, 1600, 1200, 1600, 1200, 0000, 150,  1600, 900,  0, 0, 1600, 900 },	/*custom1*/
};
...
static void sensor_init(void)
{
	...
	write_cmos_sensor(0xf8, 0x34);//0x38
	...
	write_cmos_sensor(0x04, 0x83);//0x7d
	...
	write_cmos_sensor(0x2a, 0x0c);//0x0a
...
static void custom1_setting(void)
{
	...
	write_cmos_sensor(0x90, 0x01);
	write_cmos_sensor(0x91, 0x00);
	write_cmos_sensor(0x92, 0x9c);
	write_cmos_sensor(0x93, 0x00);
	write_cmos_sensor(0x94, 0x06);
	write_cmos_sensor(0x95, 0x03);
	write_cmos_sensor(0x96, 0x84);
	write_cmos_sensor(0x97, 0x06);
	write_cmos_sensor(0x98, 0x40);
	write_cmos_sensor(0xfe, 0x00);
#if 0
	...
	case SENSOR_FEATURE_GET_CUSTOM_INFO:
		...
		switch (*feature_data) {
			...
			if (*feature_para_len >= sizeof(MUINT32)*13 + 2) {
			    *(MUINT32 *)(uintptr_t)((feature_data+1)) = GC02M1PD2164_OTP_ERROR_CODE;//otp_state
				memcpy( feature_data+2, sn_inf_main2_gc02m1pd2164, sizeof(MUINT32)*13); 
				memcpy( feature_data+10, material_inf_main2_gc02m1pd2164, sizeof(MUINT32)*4); 
						for (i = 0 ; i<12 ; i++ ){
						printk("sn_inf_main2_gc02m1pd2164[%d]= 0x%x\n", i, sn_inf_main2_gc02m1pd2164[i]);
						}
			}
				break;
			}
...
UINT32 GC02M1PD2164_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{

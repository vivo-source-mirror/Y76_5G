...
#define PFX "OV02B10PD2156_camera_sensor"
#define LOG_1 LOG_INF("OV02B10PD2156,MIPI 1LANE\n")
/***************************   Modify end    *******************************/
...
//vivo lishuo add for otp remake 20210823 [B210820-3030] begin
struct IMGSENSOR_SENSOR_TABLEINFO ov02b10pd2156_otpinfo={
	.OTP_slave_addr = 0xA4,
	.OTP_size = 0x143F ,
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = OV02B10PD2156_SENSOR_ID,
...
extern int ov02b10pd2156_otp_read(void);
extern otp_error_code_t OV02B10PD2156_OTP_ERROR_CODE;
 MUINT32  sn_inf_main_ov02b10pd2156[13];  /*0 flag   1-12 data*/
 MUINT32  material_inf_main_ov02b10pd2156[4];
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
	...
	kal_uint8 retry_cnt = retry_total;
		...
		kal_uint8 timeout = 0;
		timeout = check_i2c_timeout(0x02e0, imgsensor.i2c_write_id);
	    if (timeout) {
				  ...
				  UINT8 *feature_para, UINT32 *feature_para_len)
{
	...
	case SENSOR_FEATURE_GET_CUSTOM_INFO: //vivo lishuo modify for otp remake 20210823 [B210820-3030] 
		switch (*feature_data) {
			case 0:    
				memcpy((MUINT8 *)feature_data,(MUINT8 *)&ov02b10pd2156_otpinfo,sizeof(struct IMGSENSOR_SENSOR_TABLEINFO));
				break;
			default:
...
static MUINT32 ov02b10pd2156GetOtpInfo(struct IMGSENSOR_SENSOR_TABLEINFO **p){  
    if(p != NULL){
        *p = &ov02b10pd2156_otpinfo;
...
static struct SENSOR_FUNCTION_STRUCT sensor_func = {
	...
	NULL,
	NULL,
	ov02b10pd2156GetOtpInfo //vivo lishuo add for otp remake 20210823 [B210820-3030]
};

UINT32 OV02B10PD2156_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
	/* To Do : Check Sensor status here */
	if (pfFunc != NULL)
		*pfFunc = &sensor_func;
	return ERROR_NONE;
}				/*      OV02B10PD2156_MIPI_RAW_SensorInit      */

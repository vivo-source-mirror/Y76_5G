 ...
 * Filename:
 * ---------
 *	 s5k4h7yxv1pd2164mipiraw_Sensor.c
 *
 * Project:
 * --------
 *	 ALPS
...
#define PFX "S5K4H7YXV1PD2164_camera_sensor"
...
#include "s5k4h7yxv1pd2164mipiraw_Sensor.h"
...
int Current_frame_lengthv1 = 0;

static struct imgsensor_info_struct imgsensor_info = {
      .sensor_id = S5K4H7YXV1PD2164_SENSOR_ID,
      ...
      .pre = {
              ...
              .mipi_pixel_rate = 291200000, //// 303200000
              .max_framerate = 300,
...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[10] = {
	  ...
	  { 3264, 2448,	  0,	  0,   3264, 2448, 3264, 2448, 0000, 0000, 3264, 2448,	0,	0, 3264, 2448}, // custom2
...
extern int S5K4H7YXV1PD2164_otp_read(void);
int vivo_sub_otp_read_when_power_on_s5k4h7yxv1pd2164;
extern otp_error_code_t S5K4H7YXV1PD2164_OTP_ERROR_CODE;
#endif
extern unsigned int is_atboot;
MUINT32  sn_inf_sub_s5k4h7yxv1pd2164[13];  /*0 flag   1-12 data*/
MUINT32  material_inf_sub_s5k4h7yxv1pd2164[4];  /*0 flag   1-12 data*/
extern bool vivo_read_eeprom_s5k4h7yxv1pd2164(kal_uint16 addr,  BYTE *data);
  ...
  if(imgsensor.sensor_mode == IMGSENSOR_MODE_HIGH_SPEED_VIDEO)
    {
	  ...
	  if(Current_frame_lengthv1 >imgsensor.frame_length)
	  {
	     write_cmos_sensor_16_8(0x0341, imgsensor.frame_length & 0xFF);
		 write_cmos_sensor_16_8(0x0340, imgsensor.frame_length >> 8);
	  }
	  ...
	  Current_frame_lengthv1 =imgsensor.frame_length ;      
...
kal_uint16 addr_data_pair_init_s5k4h7yxv1pd2164[] = {
0x0100, 0x00,
0x0B05, 0x01,
0x3074, 0x06,
0x3075, 0x2F,
...
0x3931, 0x01, /// 00-427mv , 01-327mv ,02-470mv ,03-411mv
};

kal_uint16 addr_data_pair_preview_s5k4h7yxv1pd2164[] = {
0x0136, 0x1A,
0x0137, 0x00,
0x0305, 0x04,
0x0306, 0x00,
...
kal_uint16 addr_data_pair_capture_s5k4h7yxv1pd2164[] = {
0x0136, 0x1A,
0x0137, 0x00,
0x0305, 0x04,
0x0306, 0x00,
...
kal_uint16 addr_data_pair_normal_video_s5k4h7yxv1pd2164[] = {
0x0136, 0x1A,
0x0137, 0x00,
0x0305, 0x04,
0x0306, 0x00,
...
kal_uint16 addr_data_pair_hs_video_s5k4h7yxv1pd2164[] = {
0x0136, 0x1A,
0x0137, 0x00,
0x0305, 0x04,
0x0306, 0x00,
...
kal_uint16 addr_data_pair_slim_video_s5k4h7yxv1pd2164[] = {
0x0136, 0x1A,
0x0137, 0x00,
0x0305, 0x04,
0x0306, 0x00,
...
kal_uint16 addr_data_pair_custom1_s5k4h7yxv1pd2164[] = {
0x0136, 0x1A,
0x0137, 0x00,
0x0305, 0x04,
0x0306, 0x00,
...
kal_uint16 addr_data_pair_custom2_s5k4h7yxv1pd2164[] = {
0x0136, 0x1A,
0x0137, 0x00,
0x0305, 0x04,
0x0306, 0x00,
...
kal_uint16 addr_data_pair_custom3_s5k4h7yxv1pd2164[] = {
0x0136, 0x1A,
0x0137, 0x00,
0x0305, 0x04,
0x0306, 0x00,
...
kal_uint16 addr_data_pair_custom4_s5k4h7yxv1pd2164[] = {
0x0136, 0x1A,
0x0137, 0x00,
0x0305, 0x04,
0x0306, 0x00,
...
kal_uint16 addr_data_pair_custom5_s5k4h7yxv1pd2164[] = {
0x0136, 0x1A,
0x0137, 0x00,
0x0305, 0x04,
0x0306, 0x00,
...
{	
  ...
  table_write_cmos_sensor(addr_data_pair_init_s5k4h7yxv1pd2164,
                          sizeof(addr_data_pair_init_s5k4h7yxv1pd2164) / sizeof(kal_uint16));
}				/*      sensor_init  */

static void preview_setting(void)
{	
  pr_debug("preview_setting() E\n");
  table_write_cmos_sensor(addr_data_pair_preview_s5k4h7yxv1pd2164,
                          sizeof(addr_data_pair_preview_s5k4h7yxv1pd2164) / sizeof(kal_uint16));
}				/*      preview_setting  */
...
static void capture_setting(kal_uint16 currefps)
{
  ...
  table_write_cmos_sensor(addr_data_pair_capture_s5k4h7yxv1pd2164,
                          sizeof(addr_data_pair_capture_s5k4h7yxv1pd2164) / sizeof(kal_uint16));
}
...
static void normal_video_setting(kal_uint16 currefps)
{
  ...
  table_write_cmos_sensor(addr_data_pair_normal_video_s5k4h7yxv1pd2164,
                          sizeof(addr_data_pair_normal_video_s5k4h7yxv1pd2164) / sizeof(kal_uint16));
}

static void hs_video_setting(void)
{
  pr_debug("hs_video_setting() E\n");
  table_write_cmos_sensor(addr_data_pair_hs_video_s5k4h7yxv1pd2164,
                          sizeof(addr_data_pair_hs_video_s5k4h7yxv1pd2164) / sizeof(kal_uint16));
}

static void slim_video_setting(void)
{
  pr_debug("slim_video_setting() E\n");
  table_write_cmos_sensor(addr_data_pair_slim_video_s5k4h7yxv1pd2164,
                          sizeof(addr_data_pair_slim_video_s5k4h7yxv1pd2164) / sizeof(kal_uint16));

}
static void custom1_setting(void)
{
	pr_debug("start \n");
	table_write_cmos_sensor(addr_data_pair_custom1_s5k4h7yxv1pd2164,
		   sizeof(addr_data_pair_custom1_s5k4h7yxv1pd2164) / sizeof(kal_uint16));
	pr_debug("end \n");
}
...
{
	pr_debug("start \n");
	table_write_cmos_sensor(addr_data_pair_custom2_s5k4h7yxv1pd2164,
		   sizeof(addr_data_pair_custom2_s5k4h7yxv1pd2164) / sizeof(kal_uint16));
	pr_debug("end \n");
}
...
{
	pr_debug("start \n");
	table_write_cmos_sensor(addr_data_pair_custom3_s5k4h7yxv1pd2164,
		   sizeof(addr_data_pair_custom3_s5k4h7yxv1pd2164) / sizeof(kal_uint16));
	pr_debug("end \n");
}
...
{
	pr_debug("start \n");
	table_write_cmos_sensor(addr_data_pair_custom4_s5k4h7yxv1pd2164,
		   sizeof(addr_data_pair_custom4_s5k4h7yxv1pd2164) / sizeof(kal_uint16));
	pr_debug("end \n");
}
...
{
	pr_debug("start \n");
	table_write_cmos_sensor(addr_data_pair_custom5_s5k4h7yxv1pd2164,
		   sizeof(addr_data_pair_custom5_s5k4h7yxv1pd2164) / sizeof(kal_uint16));
	pr_debug("end \n");
}
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
  ...
  kal_uint8 retry = 2;
  int offset = 0xF;
  unsigned char material_inf_sub_s5k4h7yxv1pd2164[4];
  ...
  while (imgsensor_info.i2c_addr_table[i] != 0xff) {
     ...
     *sensor_id = (((read_cmos_sensor_16_8(0x0000) << 8) | read_cmos_sensor_16_8(0x0001) ) + 1);	
	  ...
	  for(j = 0;j < 4;j++){
					vivo_read_eeprom_s5k4h7yxv1pd2164(offset,&material_inf_sub_s5k4h7yxv1pd2164[j]);	
					offset++;
				}			
				if((int)material_inf_sub_s5k4h7yxv1pd2164[3] == 0x48) {
      if (*sensor_id == imgsensor_info.sensor_id) {
       ...
       pr_info("AT mode skip now return\n");
        ...
        pr_debug("add:start read eeprom  - when_power_on  = %d\n",vivo_sub_otp_read_when_power_on_s5k4h7yxv1pd2164);
        sensor_init();
        vivo_sub_otp_read_when_power_on_s5k4h7yxv1pd2164=S5K4H7YXV1PD2164_otp_read();
         ...
         *	pr_debug(
         *	"sp8Flag(0x%x),0x5003 used by s5k4h7yxv1pd2164\n", sp8spFlag);
         *
         *	if (sp8spFlag == 0x5003) {
         *		pr_debug("it is s5k4h7yxv1pd2164\n");
         *		return ERROR_NONE;
         *	}
         *
         *		pr_debug(
                                  ...
                                  UINT8 *feature_para, UINT32 *feature_para_len)
{
	...
	case SENSOR_FEATURE_GET_CUSTOM_INFO:
		...
		case 0:    //info type: otp state
			*(MUINT32 *)(uintptr_t)(*(feature_data+1)) = S5K4H7YXV1PD2164_OTP_ERROR_CODE;//otp_state
			memcpy(feature_data+2, sn_inf_sub_s5k4h7yxv1pd2164, sizeof(MUINT32)*13);
			memcpy( feature_data+10, material_inf_sub_s5k4h7yxv1pd2164, sizeof(MUINT32)*4); 
			break;
		}
		break;
		#endif
...
UINT32 S5K4H7YXV1PD2164_MIPI_RAW_SensorInit(

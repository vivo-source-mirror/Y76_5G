 ...
 *
 ****************************************************************************/
#ifndef _S5K4H7YXV1PD2164MIPI_SENSOR_H
#define _S5K4H7YXV1PD2164MIPI_SENSOR_H
...
struct imgsensor_info_struct {
	...
	struct imgsensor_mode_struct custom1;	//custom4 scenario relative information
	struct imgsensor_mode_struct custom2;	//custom4 scenario relative information
	struct imgsensor_mode_struct custom3;	//custom4 scenario relative information
	struct imgsensor_mode_struct custom4;	//custom4 scenario relative information
	struct imgsensor_mode_struct custom5;	//custom4 scenario relative information

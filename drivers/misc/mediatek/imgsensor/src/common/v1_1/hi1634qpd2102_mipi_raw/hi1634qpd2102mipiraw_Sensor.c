...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = HI1634QPD2102_SENSOR_ID,
	...
	.pre = {
		...
		.max_framerate = 300,
		.mipi_pixel_rate = 340400000//848*4/10
	},
	.cap = {
		.pclk = 640000000,
		.linelength = 5680,
		...
		.mipi_data_lp2hs_settle_dc = 85,
		.max_framerate = 300,
		.mipi_pixel_rate = 678700000//1696*4/10
	},
	.normal_video = {
	  .pclk = 640000000,				//record different mode's pclk
		.linelength =  5680, 			//record different mode's linelength
    ...
    .slim_video = {
		...
		.startx = 0,
		.starty = 0,
    	.grabwindow_width = 1160,
    	.grabwindow_height = 872,
    	.mipi_data_lp2hs_settle_dc = 85,//unit , ns
    	.max_framerate = 300,
    	.mipi_pixel_rate = 340400000//848*4/10 - temp
    },
	...
	*/
	...
	.isp_driving_current = ISP_DRIVING_2MA, //ISP_DRIVING_2MA,
...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[5] = {
	{ 4704, 3512,	0,	 0, 4704, 3512,  2352, 1756,  12,  2, 2320, 1740, 0, 0, 2320, 1740}, 	// preview (2320 x 1740)
	{ 4704, 3512,	0,	 0, 4704, 3512,  4704, 3512,  24,  4, 4640, 3480, 0, 0, 4640, 3480}, 	// capture (4640 x 3496)
	{ 4704, 3512,	0,	 0, 4704, 3512,  2352, 1756,  12,  2, 2320, 1312, 0, 0, 2320, 1740}, 	// video (2320 x 1312)
	{ 4704, 3512,	0, 482, 4704, 2548,  2352, 1274,  536, 277,	1280,  720, 0, 0, 1280,  720}, 	// hs video (1280 x 720)
	{ 4704, 3512,	0, 672, 4704, 2168,  2352, 1084,  216,  2,	1160, 872, 0, 0, 1160, 872}, 	// slim video (1160 x 872)
};
...
UINT32 HI1634QPD2102_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{

...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = S5K3P9SP04_SENSOR_ID,
	...
	.custom4 = {
		...
		.startx = 0,
		.starty = 0,
		.grabwindow_width = 1632,////2320
		.grabwindow_height = 1224, ////1744
		.mipi_data_lp2hs_settle_dc = 85,
		/*	 following for GetDefaultFramerateByScenario()	*/
...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[10] = {  
	...
	{ 4640, 3488,	688,520, 3264, 2448, 1632,  1224, 0000, 0000,  1632, 1224,	  0,	0, 1632, 1224}, /*custom4*/
...
UINT32 S5K3P9SP04_MIPI_RAW_SensorInit(

...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = S5K3P9SPPD2156F_SENSOR_ID,
	...
	.custom4 = {
		...
		.mipi_data_lp2hs_settle_dc = 85,
		/*	 following for GetDefaultFramerateByScenario()	*/
		.mipi_pixel_rate = 397800000, //332800000,
		.max_framerate = 300,
	},
	.custom5 = {
        .pclk = 555286000,
...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[10] = {  
	...
	{ 4640, 3488,1040,1024, 2560, 1440, 1280,   720, 0000, 0000, 1280,   720,	  0,	0, 1280, 720}, /*hs_video,don't use*/
	...
	{ 4640, 3488,	  0,436, 4640, 2616, 2320,  1308, 0000, 0000, 2320,  1308,	  0,	0, 2320, 1308}, /*custom2*/
	{ 4640, 3488,	  0,	0, 4640, 3488, 4640,  3488, 0000, 0000, 4640,  3488,	  0,	0, 4640, 3488}, /*capture*/  /*custom3*/
				  ...
				  UINT8 *feature_para, UINT32 *feature_para_len)
{
	...
	case SENSOR_FEATURE_GET_CUSTOM_INFO:
	    printk("SENSOR_FEATURE_GET_CUSTOM_INFO information type:%lld  S5K3P9SP_OTP_ERROR_CODE:%d \n", *feature_data,S5K3P9SP_OTP_ERROR_CODE);
		switch (*feature_data) {
...
UINT32 S5K3P9SPPD2156F_MIPI_RAW_SensorInit(

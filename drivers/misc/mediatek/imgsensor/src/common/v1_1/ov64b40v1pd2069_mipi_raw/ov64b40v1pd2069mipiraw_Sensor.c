 ...
 * 2020/07/09?¨ºoadd 4032x3024 res
 * 2020/09/16: update latest setting. 
 * ***************************************************************************
 *
 * Filename:
 * ---------
 *	 ov64b40v1pd2069mipiraw_Sensor.c
 *
 * Project:
 * --------
 *	 ALPS
...
#define PFX "ov64b40v1pd2069_camera_sensor"
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = OV64B40V1PD2069_SENSOR_ID,
...
extern int ov64b40v1pd2069_otp_read(void);
extern otp_error_code_t OV64B40V1PD2069_OTP_ERROR_CODE;
MUINT32  sn_inf_main_ov64b40v1pd2069[13];  /*0 flag   1-12 data*/
MUINT32  crosstalk_main_ov64b40v1pd2069[299]; 
MUINT32  material_inf_main_ov64b40v1pd2069[4];  
...
static void sensor_init(void)
{
	...
	for(i = 0; i<288; i++){
    write_cmos_sensor_16_8(0x5a40 + i, crosstalk_main_ov64b40v1pd2069[i+1]); 
    }
...
static kal_uint32 return_sensor_id(void)
{
    ...
    return (1 + ((read_cmos_sensor_16_8(0x300b) << 8) | ((read_cmos_sensor_16_8(0x300c)))));
}
		...
		do {
			*sensor_id = return_sensor_id();
			...
			if ( *sensor_id == imgsensor_info.sensor_id) {
				...
				vivo_otp_read_when_power_on = ov64b40v1pd2069_otp_read();
				pr_debug("read eeprom ---vivo_otp_read_when_power_on = %d,OV64B40V1PD2069_OTP_ERROR_CODE=%d\n", vivo_otp_read_when_power_on, OV64B40V1PD2069_OTP_ERROR_CODE);
				/*vivo lxd add end*/
				return ERROR_NONE;
			}
...
/*
    ...
    */
	...
	case SENSOR_FEATURE_GET_CUSTOM_INFO:
	    printk("SENSOR_FEATURE_GET_CUSTOM_INFO information type:%lld  OV64B40V1PD2069_OTP_ERROR_CODE:%d \n", *feature_data,OV64B40V1PD2069_OTP_ERROR_CODE);
		switch (*feature_data) {
			...
			if (*feature_para_len >= sizeof(MUINT32)*13 + 2) {
			    *(MUINT32 *)(uintptr_t)(*(feature_data+1)) = OV64B40V1PD2069_OTP_ERROR_CODE;//otp_state
				memcpy( feature_data+2, sn_inf_main_ov64b40v1pd2069, sizeof(MUINT32)*13); 
				memcpy( feature_data+10, material_inf_main_ov64b40v1pd2069, sizeof(MUINT32)*4); 
				#if 0
						for (i = 0 ; i<12 ; i++ ){
						printk("sn_inf_main_ov64b40v1pd2069[%d]= 0x%x\n", i, sn_inf_main_ov64b40v1pd2069[i]);
						}
				#endif
			}
				break;
...
UINT32 OV64B40V1PD2069_MIPI_RAW_SensorInit(

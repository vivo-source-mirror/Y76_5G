...
enum IMGSENSOR_HW_PIN {
	...
	IMGSENSOR_HW_PIN_I2C,
	IMGSENSOR_HW_PIN_AVDD,
	IMGSENSOR_HW_PIN_DVDD,
#ifdef CONFIG_REGULATOR_FAN53870 //for fan53870 and so on
    IMGSENSOR_HW_PIN_PLUGIC_EN,
#endif
...
//vivo zhouyikuan modify for power down i2c level is high
#define I2C         IMGSENSOR_HW_PIN_I2C
...
#define AFVDD_DEF   IMGSENSOR_HW_PIN_AFVDD
#ifdef CONFIG_REGULATOR_FAN53870
#define PLUGIC_EN   IMGSENSOR_HW_PIN_PLUGIC_EN
#endif

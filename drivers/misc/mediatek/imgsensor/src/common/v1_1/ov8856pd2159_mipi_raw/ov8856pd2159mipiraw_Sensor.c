...
//#include "ov8856pd2159mipiraw_freq.h"
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = OV8856PD2159_SENSOR_ID,
...
extern int vivo_main2_otp_read_ov8856pd2159(void);
extern otp_error_code_t MAIN2_OTP_ERROR_CODE_OV8856PD2159;
MUINT32  sn_inf_main2_ov8856pd2159[13];  /*0 flag   1-12 data*/
MUINT32  material_inf_main2_ov8856pd2159[4];  
		...
		do {
			*sensor_id = ((read_cmos_sensor_16_8(0x300B) << 8) | read_cmos_sensor_16_8(0x300C));
			if (*sensor_id == imgsensor_info.sensor_id) {
				...
				vivo_otp_read_when_power_on = vivo_main2_otp_read_ov8856pd2159();
				pr_debug("read eeprom ---vivo_otp_read_when_power_on = %d,MAIN2_885A_OTP_ERROR_CODE=%d\n", vivo_otp_read_when_power_on, MAIN2_OTP_ERROR_CODE_OV8856PD2159);
	...
	case SENSOR_FEATURE_GET_CUSTOM_INFO:
		...
		switch (*feature_data) {
			...
			if (*feature_para_len >= sizeof(MUINT32)*13 + 2) {
			    *(MUINT32 *)(uintptr_t)((feature_data+1)) = MAIN2_OTP_ERROR_CODE_OV8856PD2159;//otp_state
				memcpy( feature_data+2, sn_inf_main2_ov8856pd2159, sizeof(MUINT32)*13); 
				memcpy( feature_data+10, material_inf_main2_ov8856pd2159, sizeof(MUINT32)*4); 
				#if 0
						for (i = 0 ; i<12 ; i++ ){
						printk("sn_inf_main2_ov8856pd2159[%d]= 0x%x\n", i, sn_inf_main2_ov8856pd2159[i]);
						}
				#endif
			}
				break;
...
UINT32 OV8856PD2159_MIPI_RAW_SensorInit(

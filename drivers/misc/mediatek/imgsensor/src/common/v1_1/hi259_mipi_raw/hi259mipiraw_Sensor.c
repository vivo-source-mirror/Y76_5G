...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = HI259_SENSOR_ID, //HI259_SENSOR_ID,  /*sensor_id = 0x00E1*/ //record sensor id defined in Kd_imgsensor.h
...
extern int hi259_vivo_otp_read(void);
static int vivo_otp_read_when_power_on_hi259 = 0;
MUINT32  sn_inf_main_hi259 [13];  /*0 flag   1-12 data*/
extern otp_error_code_t HI259_OTP_ERROR_CODE;
extern unsigned int is_atboot;
extern unsigned  int hi259_flag;
...
static void write_cmos_sensor_hi259_gc2375(kal_uint32 addr, kal_uint32 para)
{
	char pu_send_cmd[2] = {
...
static void set_mirror_flip(kal_uint8 image_mirror)
{
	...
	/********************************************************
	   *
	   *   0x10 [page mode 0]: VDOCTL1 [default=0x00, r/w] 
	   *   0x11 [page mode 0]: VDOCTL2 [default=0x80, r/w] 
	   *     B[1] Y Flip Vertical Flip Function (0:OFF, 1:ON) 
	   *	 B[0] X Flip Horizontal Flip Function (0:OFF, 1:ON)
	   *
	   ********************************************************/
	...
	switch (image_mirror) {
		case IMAGE_NORMAL:
			write_cmos_sensor(0x03,0x00);
			write_cmos_sensor(0x11,0x80); // n flip  //mirror 0x80,0x81,0x82,0x83

			break;
		case IMAGE_H_MIRROR:
			write_cmos_sensor(0x03,0x00);
			write_cmos_sensor(0x11,0x81); // h flip  //mirror 0x80,0x81,0x82,0x83
		...
		case IMAGE_HV_MIRROR:
			write_cmos_sensor(0x03,0x00);
			write_cmos_sensor(0x11,0x83); // hv flip  //mirror 0x80,0x81,0x82,0x83
...
//////////////////
 ...
 write_cmos_sensor(0x29	,0xb0);		//20150127
 write_cmos_sensor(0x2a	,0x06);		//20150127
 write_cmos_sensor(0x2b	,0x40);		//20150127
 ...
 write_cmos_sensor(0x85	,0x40);		//20150127
 write_cmos_sensor(0x86	,0x04);		//20150127
 write_cmos_sensor(0x87	,0xb0);		//20150127
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
	...
	if (pgi2c_cfg_legacy != NULL){
		...
		LOG_INF("hi259mipiraw_Sensor I2C_BUS = %d\n", I2C_BUS);	
		if(I2C_BUS != 2){	
		...
		do {
        	*sensor_id = return_sensor_id();
			...
			if (*sensor_id == imgsensor_info.sensor_id) {
				...
				vivo_otp_read_when_power_on_hi259 = hi259_vivo_otp_read();
	#ifdef SLT_DEVINFO_CMM
...
static kal_uint32 open(void)
{
	...
	write_cmos_sensor_hi259_gc2375(0xef,0x00);
	write_cmos_sensor_hi259_gc2375(0xfc,0x8f);
	write_cmos_sensor_hi259_gc2375(0xf9,0x43);
	sensor_init();
...
//    unsigned long long *feature_return_para=(unsigned long long *) feature_para;
    ...
    case SENSOR_FEATURE_GET_CUSTOM_INFO:
    	LOG_INF("SENSOR_FEATURE_GET_CUSTOM_INFO information type:%lld  HI259_OTP_ERROR_CODE:%d \n", *feature_data,HI259_OTP_ERROR_CODE);
		switch (*feature_data) {
			case 0:    //info type: otp state
				...
				if (*feature_para_len >= sizeof(MUINT32)*13 + 2) {
					*(MUINT32 *)(uintptr_t)(*(feature_data+1)) = HI259_OTP_ERROR_CODE;//otp_state
					memcpy( feature_data+2, sn_inf_main_hi259, sizeof(MUINT32)*13); 
					#if 0
						for (i = 0 ; i<13 ; i++ ){
						printk("sn_inf_main_hi259[%d]= 0x%x\n", i, sn_inf_main_hi259[i]);
						}

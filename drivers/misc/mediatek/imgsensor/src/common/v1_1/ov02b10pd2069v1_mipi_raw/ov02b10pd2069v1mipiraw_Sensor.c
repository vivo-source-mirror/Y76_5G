...
#define PFX "OV02B10PD2069V1_camera_sensor"
#define LOG_1 LOG_INF("OV02B10PD2069V1,MIPI 1LANE\n")
/***************************   Modify end    *******************************/
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = OV02B10PD2069V1_SENSOR_ID,
...
extern int ov02b10pd2069v1_otp_read(void);
extern otp_error_code_t OV02B10PD2069V1_OTP_ERROR_CODE;
 MUINT32  sn_inf_main_ov02b10pd2069v1[13];  /*0 flag   1-12 data*/
 MUINT32  material_inf_main_ov02b10pd2069v1[4];
...
{
	LOG_INF("[%s]image_mirror = %d\n", __func__, image_mirror);
...
{
	LOG_INF("B210425-1686 preview_setting before E\n");
	sensor_init();
	LOG_INF("B210425-1686 preview_setting after E\n");
	LOG_INF("E\n");
	/*
	 * @@Initial - MIPI 1-Lane 1600x1200 10-bit 30fps
	 * 100 99 1600 1200
		...
		do {
			*sensor_id = return_sensor_id();
			if (*sensor_id == imgsensor_info.sensor_id) {
				...
				vivo_otp_read_when_power_on = ov02b10pd2069v1_otp_read();
				LOG_INF("ov02b10 read eeprom ---vivo_otp_read_when_power_on = %d,OV02B10PD2069V1_OTP_ERROR_CODE=%d\n", vivo_otp_read_when_power_on, OV02B10PD2069V1_OTP_ERROR_CODE);
				/*vivo lxd add end*/
				return ERROR_NONE;
			}
				  ...
				  UINT8 *feature_para, UINT32 *feature_para_len)
{
	...
	case SENSOR_FEATURE_GET_CUSTOM_INFO:
	    printk("SENSOR_FEATURE_GET_CUSTOM_INFO information type:%lld  OV02B10PD2069V1_OTP_ERROR_CODE:%d \n", *feature_data,OV02B10PD2069V1_OTP_ERROR_CODE);
		switch (*feature_data) {
			...
			if (*feature_para_len >= sizeof(MUINT32)*13 + 2) {
			    *(MUINT32 *)(uintptr_t)(*(feature_data+1)) = OV02B10PD2069V1_OTP_ERROR_CODE;//otp_state
				memcpy( feature_data+2, sn_inf_main_ov02b10pd2069v1, sizeof(MUINT32)*13); 
				memcpy( feature_data+10, material_inf_main_ov02b10pd2069v1, sizeof(MUINT32)*4); 
				#if 0
						for (i = 0 ; i<12 ; i++ ){
						printk("sn_inf_main_ov02b10pd2069v1[%d]= 0x%x\n", i, sn_inf_main_ov02b10[i]);
						}
				#endif
			}
				break;
...
UINT32 OV02B10PD2069V1_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
	/* To Do : Check Sensor status here */
	if (pfFunc != NULL)
		*pfFunc = &sensor_func;
	return ERROR_NONE;
}				/*      OV02B10PD2069V1_MIPI_RAW_SensorInit      */

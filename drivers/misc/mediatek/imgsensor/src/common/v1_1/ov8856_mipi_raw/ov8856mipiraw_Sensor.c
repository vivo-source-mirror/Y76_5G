...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[10] = {  
	...
	{ 3264, 2448,	0,	  444,	 3264, 1560, 3264, 1560, 592, 0, 2080, 1560,  0,  0, 2080, 1560}, // custom2	  
...
extern otp_error_code_t OV8856_OTP_ERROR_CODE;
MUINT32  sn_inf_main2_ov8856[13];  /*0 flag   1-12 data*/
MUINT32  material_inf_main2_ov8856[4];  
	...
	case SENSOR_FEATURE_GET_CUSTOM_INFO:
		...
		switch (*feature_data) {
			...
			if (*feature_para_len >= sizeof(MUINT32)*13 + 2) {
			    *(MUINT32 *)(uintptr_t)(*(feature_data+1)) = OV8856_OTP_ERROR_CODE;//otp_state
				memcpy( feature_data+2, sn_inf_main2_ov8856, sizeof(MUINT32)*13); 
				memcpy( feature_data+10, material_inf_main2_ov8856, sizeof(MUINT32)*4); 
				#if 0
						for (i = 0 ; i<12 ; i++ ){
						printk("sn_inf_main2_ov8856[%d]= 0x%x\n", i, sn_inf_main2_ov8856[i]);
						}
				#endif
			}
				break;
...
UINT32 OV8856_MIPI_RAW_SensorInit(

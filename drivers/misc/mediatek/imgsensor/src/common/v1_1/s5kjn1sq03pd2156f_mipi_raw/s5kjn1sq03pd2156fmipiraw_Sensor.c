 ...
 * Filename:
 * ---------
 *	 s5kjn1sq03pd2156fmipiraw_Sensor.c
 *
 * Project:
 * --------
 *	 ALPS
...
#include "s5kjn1sq03pd2156fmipiraw_freq.h"
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = S5KJN1SQ03PD2156F_SENSOR_ID,
...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[10] = {
	...
	{8160, 6144,   816,  624, 6528, 4896, 3264, 2448, 0, 0, 3264, 2448, 0, 0, 3264, 2448}, /* custom1 */
...
{/* Preview mode setting 4080*3060*/
	...
	/* custom1 mode setting 3264*2448 30fps*/
	{0x02, 0x0a, 0x00, 0x08, 0x40, 0x00,
	 0x00, 0x2b, 0x1200, 0x0D70, 0x00, 0x00, 0x00, 0x00,
...
static struct SET_PD_BLOCK_INFO_T imgsensor_pd_info =  //4080X3072
{
	...
	.i4BlockNumY = 382,
	.iMirrorFlip = 3,
	.i4Crop = { {0,6}, {0,6}, {0, 388}, {0, 0}, {0, 0}, {408,312}, {120, 456}, {0, 0}, {0, 388}, {0, 6}},
};
#endif
#if 1
...
extern otp_error_code_t S5KJN1SQ03PD2156F_OTP_ERROR_CODE;
MUINT32  af_calib_inf_main_s5kjn1sq03pd2156f[6];
#endif
MUINT32  sn_inf_main_s5kjn1sq03pd2156f[13];  /*0 flag   1-12 data*/
MUINT32 crosstalk_data_PD2156f[8006];  /*0 flag   1-836 data*/
MUINT32  material_inf_main_s5kjn1sq03pd2156f[4];
...
static kal_uint16 addr_data_pair_custom1[] = {
    ...
    0x6028, 0x4000,
    0xF46A, 0xAE80,
    0x0344, 0x0330,   //0x0000
    0x0346, 0x0270,   //0x000C
    0x0348, 0x1CCF,   //0x1FFF
    0x034A, 0x15AF,   //0x1813
    0x034C, 0x0CC0,   //0x0FF0  4080
    0x034E, 0x0990,   //0x0BF4  3060
    0x0350, 0x0008,
    0x0352, 0x0008,
    0x0900, 0x0122,
    0x0380, 0x0002,
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
	...
	kal_uint8 timeout = 0;
	timeout = check_i2c_timeout(0x38e2, imgsensor.i2c_write_id);
    if (timeout) {
...
#ifdef HOPE_ADD_FOR_CAM_TEMPERATURE_NODE  //add for s5kjn1sq03pd2156f temperature
				  ...
				  UINT8 *feature_para, UINT32 *feature_para_len)
{
	...
	case SENSOR_FEATURE_GET_OFFSET_TO_START_OF_EXPOSURE:
		*(MUINT32 *)(uintptr_t)(*(feature_data + 1)) = 6990000;
		break;
	...
	case SENSOR_FEATURE_GET_SENSOR_PDAF_CAPACITY:
		...
		case MSDK_SCENARIO_ID_VIDEO_PREVIEW:
			*(MUINT32 *)(uintptr_t)(*(feature_data+1)) = 1; /* 4080x2296 */
			break;
		case MSDK_SCENARIO_ID_CUSTOM1:
			*(MUINT32 *)(uintptr_t)(*(feature_data+1)) = 1; /* 3264x2448 */
			break;
		case MSDK_SCENARIO_ID_CUSTOM2:
    ...
    */
	...
	case SENSOR_FEATURE_GET_CUSTOM_INFO:
		...
		switch (*feature_data) {
			...
			if (*feature_para_len >= sizeof(MUINT32)*13 + 2) {
			    *(MUINT32 *)(uintptr_t)((feature_data+1)) = S5KJN1SQ03PD2156F_OTP_ERROR_CODE;//otp_state
				memcpy( feature_data+2, sn_inf_main_s5kjn1sq03pd2156f, sizeof(MUINT32)*13);
				memcpy( feature_data+10, material_inf_main_s5kjn1sq03pd2156f, sizeof(MUINT32)*4);
				memcpy( feature_data+12, af_calib_inf_main_s5kjn1sq03pd2156f, sizeof(MUINT32)*6);
						for (i = 0 ; i<12 ; i++ ){
						printk("sn_inf_main_s5kjn1sq03pd2156f[%d]= 0x%x\n", i, sn_inf_main_s5kjn1sq03pd2156f[i]);
						}
			}
				break;
			}
	...
	case SENSOR_FEATURE_GET_4CELL_DATA:/*get 4 cell data from eeprom*/
	{
		...
		if (type == FOUR_CELL_CAL_TYPE_XTALK_CAL) {
			...
			data[1] = 0x1F;
			for(i = 0; i< 8006 ; i++)
			data[2 + i] = crosstalk_data_PD2156f[i];
		      printk("read Cross Talk calibration data size= i= %d data=0x%x\n",
				i, data[i]);
		}
	}
    break;
...
UINT32 S5KJN1SQ03PD2156F_MIPI_RAW_SensorInit(

...
//#include "ov8856pd2069mipiraw_freq.h"
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = OV8856PD2069_SENSOR_ID,
...
extern int vivo_main3_otp_read_ov8856pd2069(void);
extern otp_error_code_t MAIN3_OTP_ERROR_CODE_OV8856PD2069;
MUINT32  sn_inf_main2_ov8856pd2069[13];  /*0 flag   1-12 data*/
MUINT32  material_inf_main2_ov8856pd2069[4];  
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
	...
	while (imgsensor_info.i2c_addr_table[i] != 0xff) {
		...
		spin_unlock(&imgsensor_drv_lock);
		do {
			*sensor_id = ((read_cmos_sensor_16_8(0x300B) << 8) | read_cmos_sensor_16_8(0x300C)) + 1;
			if (*sensor_id == imgsensor_info.sensor_id) {
				...
				vivo_otp_read_when_power_on = vivo_main3_otp_read_ov8856pd2069();
				pr_debug("read eeprom ---vivo_otp_read_when_power_on = %d,MAIN2_885A_OTP_ERROR_CODE=%d\n", vivo_otp_read_when_power_on, MAIN3_OTP_ERROR_CODE_OV8856PD2069);
	...
	case SENSOR_FEATURE_GET_CUSTOM_INFO:
		...
		switch (*feature_data) {
			...
			if (*feature_para_len >= sizeof(MUINT32)*13 + 2) {
			    *(MUINT32 *)(uintptr_t)(*(feature_data+1)) = MAIN3_OTP_ERROR_CODE_OV8856PD2069;//otp_state
				memcpy( feature_data+2, sn_inf_main2_ov8856pd2069, sizeof(MUINT32)*13); 
				memcpy( feature_data+10, material_inf_main2_ov8856pd2069, sizeof(MUINT32)*4); 
				#if 0
						for (i = 0 ; i<12 ; i++ ){
						printk("sn_inf_main2_ov8856pd2069[%d]= 0x%x\n", i, sn_inf_main2_ov8856pd2069[i]);
						}
				#endif
			}
				break;
...
UINT32 OV8856PD2069_MIPI_RAW_SensorInit(

...
typedef enum { 
	OTP_ERROR_CODE_NORMAL = 0,
    OTP_ERROR_CODE_EMPTY = 1,
    OTP_ERROR_CODE_MODULE_INFO_ERROR,
    OTP_ERROR_CODE_GROUP_INVALID,
    OTP_ERROR_CODE_CHECKSUM_ERROR,
    OTP_ERROR_CODE_AWB_OUT_OF_RANGE,
    OTP_ERROR_CODE_AF_OUT_OF_RANGE,
} otp_error_code_t;
